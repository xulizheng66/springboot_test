...
public class JSONUtil {
     ...
     * 将map转换成json字符串
     */
    public static String writeMapJSON(Map map) {
        String jsonString = "";
    ...
    public static Map<String, String> readJsonMap(String jsonString) {
        ObjectMapper objectMapper = new ObjectMapper();
    ...
    @SuppressWarnings("unchecked")
    public static List<Object> readJsonListObject(String jsonString) {
        ObjectMapper objectMapper = new ObjectMapper();
     ...
     */
    @SuppressWarnings("unchecked")
    public static List<Map> readJsonListMap(String jsonString) {
        ObjectMapper objectMapper = new ObjectMapper();
