...
public class EncodeTest {
    ...
    public static void Encode_QR_CODE(String contents) throws IOException, WriterException{
        ...
        // 生成二维码
        File outputFile = new File("C:\\Users\\xulz\\Desktop\\" + File.separator + "baidu.jpg");//指定输出路径
    ...
    public static void main(String[] args) {
        try {
            Encode_QR_CODE("http://www.baidu.com");
//        MatrixToImageWriter.crateQR("http://www.baidu.com");
        } catch (Exception e) {
