...
//		conn.setRequestProperty("X-Forwarded-For", "59.219.252.226");
		conn.setRequestProperty("X-Forwarded-For", "29.22.34.229");
...
//		String soap = getXml(namespace,methodName,patameterMap,rid,sid,rtime,sign);
		String soap = getPeopleXml(namespace,methodName,patameterMap,rid,sid,rtime,sign);
	...
	public static String getXml(String namespace,String methodName ,Map<String, String> patameterMap,String rid,String sid,String rtime,String sign) {

		StringBuffer soapRequestData = new StringBuffer();
		soapRequestData.append("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:web=\"http://webservice.tongtech.com/\"> ");
	...
	public static String getPeopleXml(String namespace,String methodName ,Map<String, String> patameterMap,String rid,String sid,String rtime,String sign) {

		StringBuffer soapRequestData = new StringBuffer();
		soapRequestData.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>");
		soapRequestData.append("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:web=\"http://webservice.com/\"> ");
		soapRequestData.append("<soapenv:Header>");
		soapRequestData.append("<tongtechheader>");
		...
		soapRequestData.append("<soapenv:Body>");
		//基准信息查询
		soapRequestData.append("<web:GK_JZCX_RKJCXXCX>");
